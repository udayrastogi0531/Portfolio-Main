...
export const mockResponses = [
  "I'm Prakshin, Uday's AI assistant! I'd be happy to tell you about his projects, skills, or how to get in touch. What would you like to know?",
  ...
  "Uday's tech stack includes React, Node.js, MongoDB, TypeScript, C++, Python, LangChain, OpenAI APIs, Pinecone/FAISS, and Supabase. He's especially strong in MERN stack and AI integrations, AI Agents , LLM Workflow.",
];
