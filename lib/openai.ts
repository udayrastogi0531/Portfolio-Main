...
export const mockResponses = [
  ...
  "Uday's tech stack includes React, Node.js, MongoDB, TypeScript, C++, Python, LangChain, OpenAI APIs, Pinecone/FAISS, and Supabase. He's especially strong in MERN stack and AI integrations, AI Agents .",
];
