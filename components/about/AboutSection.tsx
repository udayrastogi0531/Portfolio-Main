          ...
          >
            ...
            <div className="holographic-card rounded-3xl p-8 mb-8 relative overflow-hidden">
              ...
              <div className="flex items-start gap-6">
                {/* Avatar placeholder */}
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-400 to-purple-600 flex items-center justify-center text-white text-3xl font-bold flex-shrink-0 shadow-[0_0_30px_rgba(6,182,212,0.4)]">
                  U
                </div>
                <div>
